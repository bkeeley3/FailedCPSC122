/*
  ...
  Date: 1/21/2022
  Project 1
  Prints a specified number if prime numbers in a specific number of coloums determined by the user
*/
...
void error(int code) ///checks to make sure inputs are integers that are greater than or equal to 1
{
 if (code == 1)
  {
